...
/**
 * 射击点类（ShootingPoint）
 * 表示我方作战中的射击点，包含位置信息（经纬度、高度）以及与射击分析相关的各种属性。
 * 实现 Point 接口，便于统一处理敌我数据。
 */
public class ShootingPoint implements Point {
     ...
     */
    public ShootingPoint(Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public ShootingPoint build() {
            return new ShootingPoint(this);
        }
    }
    ...
    public PointRole getRole() {
        return role;
    }

    public void setRole(PointRole role) {
        this.role = role;
    }
